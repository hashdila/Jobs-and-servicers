...
$stmt = $pdo->prepare("SELECT * FROM tec WHERE id = ?");
$stmt->execute([$tec_id]);
$userDetails = $stmt->fetch();

// Fetch all job posts by the technician
$stmt = $pdo->prepare("SELECT * FROM tec_posts WHERE tec_id = ?");
$stmt->execute([$tec_id]);
$jobs = $stmt->fetchAll();
?>
...
<div class="container mt-5 text-black">
    ...
    <div class="p-4 border shadow-sm rounded bg-light position-relative">
        ...
        <div class="d-flex align-items-start mb-5">
            <img src="<?php echo htmlspecialchars($userDetails['profile_image']); ?>" alt="Profile Image" class="rounded-circle border border-secondary p-1" style="width: 150px; height: 150px;">
            <div class="ms-4">
                ...
                <p class="mb-2 fs-5"><span class="fw-bold me-2">&#x1F527;</span>Job Category: <?php echo htmlspecialchars($userDetails['job_category']); ?></p>
            </div>
        </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text fs-5"><i class="bi bi-house-door-fill me-2"></i><strong>Address:</strong> <?php echo htmlspecialchars($job['physical_address']); ?></p> <!-- Using fs-5 and added an icon for address -->
                    ...
                    <form id="deleteForm" action="tec_delete_post.php" method="post">
