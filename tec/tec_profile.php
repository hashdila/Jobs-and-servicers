...
<div class="container mt-5 text-black">
    ...
    <div class="p-4 border shadow-sm rounded bg-light position-relative">
        ...
        <div class="d-flex align-items-start mb-5">
            <img src="<?php echo htmlspecialchars($userDetails['profile_image']); ?>" alt="../tec/Profile Image" class="rounded-circle border border-secondary p-1" style="width: 150px; height: 150px;">
            <div class="ms-4">
